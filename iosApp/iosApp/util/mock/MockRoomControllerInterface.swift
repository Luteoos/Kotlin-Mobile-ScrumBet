...
class MockRoomControllerInterfrace: RoomControllerInterface {
    ...
    func getMockRoomData() -> RoomData {
        return RoomData(configuration:
                            RoomConfiguration(url: MultiUrl(base: "mockUrl.mock/mockRoomId"),roomJoinCode: "2137", isOwner: true, scale: ["1", "2", "3", "4", "5", "?"], scaleType: "MOCK1", scaleTypeList: ["MOCK1", "MOCK2"], voteEnded: true, anonymousVote: true, alwaysVisibleVote: true, autoRevealVotes: true),
