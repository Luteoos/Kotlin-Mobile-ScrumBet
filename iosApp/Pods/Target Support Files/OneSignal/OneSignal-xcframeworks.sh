...
install_xcframework "${PODS_ROOT}/OneSignal/iOS_SDK/OneSignalSDK/OneSignal_User/OneSignalUser.xcframework" "OneSignal/OneSignalUser" "framework" "ios-arm64" "ios-arm64_x86_64-maccatalyst" "ios-arm64_x86_64-simulator"
